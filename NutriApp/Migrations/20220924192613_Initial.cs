        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Lipids = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AttributesProduct", x => new { x.AttributesId, x.productsId });
                    table.ForeignKey(
                        name: "FK_AttributesProduct_Attributes_AttributesId",
                        column: x => x.AttributesId,
                        principalTable: "Attributes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AttributesProduct_Products_productsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttributesProduct_productsId",
                table: "AttributesProduct",
                column: "productsId");
